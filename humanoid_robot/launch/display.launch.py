...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'humanoid_robot.urdf'
    xacro_file = "humanoid_robot.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "humanoid_robot"
    use_urdf = False
    ...
    # Base Name or robot
    robot_base_name = "humanoid_robot"
    ####### DATA INPUT END ##########
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("humanoid_robot"), "rviz", "display_default.rviz"]
    )
